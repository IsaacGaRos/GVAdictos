...
OFFICIAL = [
    ...
    ("A1-01", "1/24", 2024, "1er ejercicio - 1a parte (teorico)",
     r"A1-01\2024\1-24_TL_manana_cuestionario_plantilla.pdf", 160),
    ("A1-01", "1/24", 2024, "1er ejercicio - 2a parte (teorico-practico)",
     r"A1-01\2024\1-24_TL_tarde_cuestionario_plantilla.pdf", 40),
    ("A1-01", "1/23", 2023, "1er ejercicio (1a y 2a parte)",
     r"A1-01\2023\1-23_primera_y_segunda_parte_cuestionario_plantilla.pdf", 160),
    ("A1-01", "120/21", 2021, "ejercicio unico (test)",
     r"A1-01\2021\120-21_cuestionario_plantilla.pdf", 120),
    ("A1-01", "2/25", 2025, "1er ejercicio (promocion interna)",
     r"A1-01\2025\2-25_PI_cuestionario_plantilla.pdf", 40),
